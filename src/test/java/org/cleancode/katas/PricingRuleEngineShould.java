...
public class PricingRuleEngineShould {
...
private PricingRuleEngine pricingRuleEngine;
	...
	public void setup(){
		...
		pricingRuleEngine = new PricingRuleEngine(asList(new Promotion(asList( new ProductPromotionDetails(productA, 1),
	...
	public void return_promotion_if_A_B_purchased(){
		...
		List<Promotion> promotions = pricingRuleEngine.getEligiblePromotions(productCountMap);
